...
PRODUCT_MAP = {
    ...
    "fruit":       ["Guava", "Papaya", "FRESH CHIKKU", "Lemon", "Chayote", "Lychee"],
    "gourd":       ["Pumpkin", "Snake Gourd", "Ridge Gourd", "Bitter Gourd", "Tindora", "Squash", "Indian Cucumber", "Drumsticks"],
    ...
    "root":        ["Potato", "Sweet Potato", "Beetroot", "Radish", "Ginger", "Garlic", "Edo", "Carrot"],
